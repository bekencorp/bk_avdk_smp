...
#endif
#if CONFIG_ADK_ONBOARD_DUAL_DMIC_MIC_STREAM_V2
#include <components/bk_audio/audio_streams/onboard_dual_dmic_mic_stream_v2.h>
#else
...
#if !(CONFIG_ADK_ONBOARD_MIC_STREAM_V2 || CONFIG_ADK_ONBOARD_SPEAKER_STREAM_V2 || CONFIG_ADK_ONBOARD_DUAL_DMIC_MIC_STREAM_V2)
/**
