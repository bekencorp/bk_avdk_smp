...
/* area 0~3: PSRAM0; area 4~7: PSRAM1 */
typedef enum {
	PSRAM_WRITE_THROUGH_AREA_0 = 0,
	PSRAM_WRITE_THROUGH_AREA_1,
	PSRAM_WRITE_THROUGH_AREA_2,
	PSRAM_WRITE_THROUGH_AREA_3,
	PSRAM_WRITE_THROUGH_AREA_4,
	PSRAM_WRITE_THROUGH_AREA_5,
	PSRAM_WRITE_THROUGH_AREA_6,
	PSRAM_WRITE_THROUGH_AREA_7,
	PSRAM_WRITE_THROUGH_AREA_COUNT
} psram_write_through_area_t;

#define PSRAM_WRITE_THROUGH_AREA_PER_PSRAM  4
