...
#if defined(__CC_ARM)
#define AVDK_SECTION_DEF(section_name, data_type)                \
...
#if defined(__CC_ARM)
#define AVDK_SECTION_ITEM_REGISTER(section_name, section_var) \
...
#define AVDK_SECTION_ITEM_GET(section_name, data_type, i) \
    ((data_type*)AVDK_SECTION_START_ADDR(section_name) + (i))

#define AVDK_SECTION_ITEM_COUNT(section_name, data_type) \
