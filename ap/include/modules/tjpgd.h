...
rott_angle_t jd_get_rotate_by_hanlde(jpeg_dec_handle_t handle);
void jd_set_rotate_by_handle(jpeg_dec_handle_t handle, rott_angle_t rotate_angle, uint8_t *rotate_buf);
