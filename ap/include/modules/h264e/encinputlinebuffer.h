...
#define VCEncStartInputLineBufferWithoutCopy(lineBufCfg, picLines) (0)
#define VCEncInputLineBufDone (NULL)
#define VCEncInputLineBufPolling() (0)
#define VCEncUpdateInitSegNum(lineBufCfg)
#define VCEncInputLineBufWrCntSet(lineBufCfg)
#else
...
u32 VCEncStartInputLineBufferWithoutCopy(inputLineBufferCfg *lineBufCfg, uint32_t picLines);
void VCEncInputLineBufDone(void *pAppData);
void VCEncInputLineBufDoneWithoutCopy(void *pAppData);
u32 VCEncInputLineBufPolling();
void VCEncUpdateInitSegNum(inputLineBufferCfg *lineBufCfg);
void VCEncInputLineBufWrCntSet(inputLineBufferCfg *lineBufCfg);
#endif
