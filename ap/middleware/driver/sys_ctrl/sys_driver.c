...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_set_ints_config_riscv_0_31(v);
	sys_drv_exit_critical(int_level);
}
...
uint32_t sys_drv_get_ints_config_riscv_0_31(void)
{
	uint32_t reg;
	uint32_t int_level = sys_drv_enter_critical();
	reg = sys_hal_get_ints_config_riscv_0_31();
	sys_drv_exit_critical(int_level);
	return reg;
}
...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_set_ints_config_riscv_32_63(v);
	sys_drv_exit_critical(int_level);
}
...
uint32_t sys_drv_get_ints_config_riscv_32_63(void)
{
	uint32_t reg;
	uint32_t int_level = sys_drv_enter_critical();
	reg = sys_hal_get_ints_config_riscv_32_63();
	sys_drv_exit_critical(int_level);
	return reg;
}