...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_set_cpu1_pwr_dw(is_pwr_down);
	sys_drv_exit_critical(int_level);
}
...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_set_cpu2_pwr_dw(is_pwr_down);
	sys_drv_exit_critical(int_level);
}
...
{
	uint32_t int_level = sys_drv_enter_critical();
	bk_err_t ret = sys_hal_auxldo_swb_set(swb,bypass);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
{
	uint32_t int_level = sys_drv_enter_critical();
	uint32_t ret = sys_hal_auxldo_swb_get(swb);
	sys_drv_exit_critical(int_level);
	return ret;
}
