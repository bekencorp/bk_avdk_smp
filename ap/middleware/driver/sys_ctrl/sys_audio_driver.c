...
uint32_t sys_drv_aud_set_ckdiv(uint32_t value)
{
	...
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_aud_set_ckdiv_audio(value);
	sys_drv_exit_critical(int_level);
...
uint32_t sys_drv_aud_dac_diffen_en(uint32_t value)
{
	...
	sys_hal_aud_dac_diffen_en(value);
	sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;
}
...
uint32_t sys_drv_aud_mic3_rst_set(uint32_t value)
{
	...
	sys_hal_aud_mic3_rst_set(value);
	sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;
}
...
uint32_t sys_drv_aud_mic3_gain_set(uint32_t value)
{
	...
	sys_hal_aud_mic3_gain_set(value);
	sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;
}
...
uint32_t sys_drv_aud_mic3_single_en(uint32_t value)
{
	...
	sys_hal_aud_mic3_single_en(value);
	sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;
}
#endif
...
uint32_t sys_drv_get_apll_en_status(void)
{
	...
	//ret = sys_hal_apll_en_get();
	//sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;//ret;
}
#endif
...
/* AUD ana_reg wrappers with critical section for multi-core safety */
void sys_drv_set_ana_reg20_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg21_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg25_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg27_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg28_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg29_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
...
void sys_drv_set_ana_reg30_value(uint32_t value)
{
	uint32_t int_level = sys_drv_enter_critical();
