...
__IRAM_SEC int32_t sys_drv_set_int_en(uint32_t core_id, uint32_t int_num, uint32_t int_en)
{
	int32_t ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_set_int_en(core_id, int_num, int_en);
...
__IRAM_SEC int32 sys_drv_int_disable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_int_disable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
__IRAM_SEC int32 sys_drv_int_enable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_int_enable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
__IRAM_SEC int32 sys_drv_int_group2_disable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_int_group2_disable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
__IRAM_SEC int32 sys_drv_int_group2_enable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_int_group2_enable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
int32 sys_drv_fiq_disable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_fiq_disable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
int32 sys_drv_fiq_enable(uint32 param)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_fiq_enable(rtos_get_core_id(),param);
	sys_drv_exit_critical(int_level);
	return ret;
}
...
uint32 sys_drv_get_int_source_status(void)
{
	uint32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_get_int_status(rtos_get_core_id());
	sys_drv_exit_critical(int_level);
	return ret;
}
...
uint32 sys_drv_get_fiq_reg_status(void)
{
	int32 ret = 0;
	uint32_t int_level = sys_drv_enter_critical();
	ret = sys_hal_get_fiq_reg_status(rtos_get_core_id());
	sys_drv_exit_critical(int_level);
	return ret;
}
...
//	sys_drv_set_int_en(rtos_get_core_id(), INT_SRC_CP_I2S0, 1);
	sys_drv_exit_critical(int_level);
	return SYS_DRV_SUCCESS;
}
...
//	sys_drv_set_int_en(rtos_get_core_id(), INT_SRC_CP_I2S1, 1);
...
//	sys_drv_set_int_en(rtos_get_core_id(), INT_SRC_CP_I2S2, 1);
...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_i2s3_int_en(value);
//	sys_drv_set_int_en(rtos_get_core_id(), INT_SRC_CP_I2S3, 1);
...
{
	uint32_t int_level = sys_drv_enter_critical();
	sys_hal_i2s4_int_en(value);
//	sys_drv_set_int_en(rtos_get_core_id(), INT_SRC_CP_I2S4, 1);
