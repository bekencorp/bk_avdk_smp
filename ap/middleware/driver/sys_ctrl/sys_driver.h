...
void sys_drv_dev_clk_pwr_ctrl(dev_clk_pwr_id_t dev, dev_clk_pwr_ctrl_t power_up);
...
void     sys_drv_set_ints_config_riscv_0_31(uint32_t v);
uint32_t sys_drv_get_ints_config_riscv_0_31(void);
void     sys_drv_set_ints_config_riscv_32_63(uint32_t v);
uint32_t sys_drv_get_ints_config_riscv_32_63(void);
