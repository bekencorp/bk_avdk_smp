...
/* P0-3: bounded/recoverable unsafe UART write, aligned with the CP driver so
 * the AP coredump path can snapshot -> soft-reset/recover -> retransmit a stuck
 * UART instead of busy-waiting forever. */
typedef struct {
