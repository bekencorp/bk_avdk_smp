...
#define BLOCKSIZE_R(addr)                         *((volatile signed short *) (addr + 0x04))
...
#define BLOCKCOUNT_R(addr)                     *((volatile signed short *)(addr + 0x06))
#define ARGUMENT_R(addr)                       *((volatile unsigned int *)(addr + 0x08))

#define XFER_MODE_R(addr)                          *((volatile signed short *)(addr + 0x0c))
...
#define CMD_R(addr)                                     *((volatile signed short *)(addr + 0x0e))
#define NO_RESP                       (0<<0)
...
#define CLK_CTRL_R(addr)                                *((volatile signed short *)(addr + 0x2c))
...
#define NORMAL_INT_STAT_R(addr)                       *((volatile signed short *)(addr + 0x30))
#define ERROR_INT_STAT_R(addr)                        *((volatile signed short *)(addr + 0x32))
#define NORMAL_INT_STAT_EN_R(addr)                    *((volatile signed short *)(addr + 0x34))
#define ERROR_INT_STAT_EN_R(addr)                     *((volatile signed short *)(addr + 0x36))
#define NORMAL_INT_SIGNAL_EN_R(addr)                  *((volatile signed short *)(addr + 0x38))
#define ERROR_INT_SIGNAL_EN_R(addr)                   *((volatile signed short *)(addr + 0x3a))
...
#define AUTO_CMD_STAT_R(addr)                         *((volatile signed short *)(addr + 0x3c))
#define HOST_CTRL2_R(addr)                            *((volatile signed short *)(addr + 0x3e))
...
#define FORCE_AUTO_CMD_STAT_R(addr)                   *((volatile signed short *)(addr + 0x50))
#define FORCE_ERROR_INT_STAT_R(addr)                  *((volatile signed short *)(addr + 0x52))
...
#define PRESET_DS_R(addr)                             *((volatile signed short *)(addr + 0x62))
#define PRESET_HS_R(addr)                             *((volatile signed short *)(addr + 0x64))
#define PRESET_SD12_R(addr)                           *((volatile signed short *)(addr + 0x66))
#define PRESET_SD25_R(addr)                           *((volatile signed short *)(addr + 0x68))
#define PRESET_SDR50_R(addr)                          *((volatile signed short *)(addr + 0x6a))
#define PRESET_SDR104_R(addr)                         *((volatile signed short *)(addr + 0x6c))
#define PRESET_DDR50_R(addr)                          *((volatile signed short *)(addr + 0x6e))
...
#define HOST_CNTRL_VERS_R(addr)                           *((volatile signed short *)(addr + 0xfe))
...
#define SNPS_EMMC_CTRL_R(addr)                            *((volatile signed short *)(addr + 0x500+0x2c))
#define SNPS_BOOT_CTRL_R(addr)                            *((volatile signed short *)(addr + 0x500+0x2e))
...
typedef enum
{
	ADMA2_ATTRIBUTE_ACT_NOP          = 0,
	ADMA2_ATTRIBUTE_ACT_RSV          = 2,
	ADMA2_ATTRIBUTE_ACT_TRAN         = 4,
	ADMA2_ATTRIBUTE_ACT_LINK         = 6,
}adma2_attribute_act_e;

#define ADMA2_ATTRIBUTE_VALID_EN         BIT(0) /* bit0 */
#define ADMA2_ATTRIBUTE_END_EN           BIT(1) /* bit1 */
#define ADMA2_ATTRIBUTE_INT_EN           BIT(2) /* bit2 */
