 ...
 * \returns 0 on success else fail -ve
 */
int sdhci_hal_unregister(struct sdhci_t *sdhci)
{
    os_memset(sdhci->pal, 0, sizeof(sdhci->pal[0]));
    os_memset(sdhci->hal, 0, sizeof(sdhci->hal[0]));
