...
#if CONFIG_IOMX_TEST && CONFIG_CLI
	extern int bk_iomx_register_cli_test_feature(void);
	bk_iomx_register_cli_test_feature();
#endif
...
static void __BK_IRQ iomx_gpio_isr(void)
{
