...
#define CONFIG_PSRAM_HEAP_BASE CONFIG_AP_PSRAM_HEAP_ADDR
#define CONFIG_PSRAM_HEAP_SIZE CONFIG_AP_PSRAM_HEAP_SIZE

#define BK_DUMP_PRINT_UART_PORT CONFIG_DUMP_UART_PRINT_PORT
#define BK_DUMP_TASK_WD_TIMER_INTERRUPT   (33)   // TODO: Set appropriate interrupt number
