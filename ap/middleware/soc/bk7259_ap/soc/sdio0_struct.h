...
typedef volatile struct {
	volatile sdio0_dev_id_t dev_id;
	volatile sdio0_ver_id_t ver_id;
	volatile sdio0_clkg_reset_t clkg_reset;
	volatile sdio0_status_t status;
	volatile sdio0_div_ctrl_t div_ctrl;
	volatile sdio0_sdio_ctrl_t sdio_ctrl;
	volatile sdio0_prot_ctrl_t prot_ctrl;
} sdio0_hw_t;
