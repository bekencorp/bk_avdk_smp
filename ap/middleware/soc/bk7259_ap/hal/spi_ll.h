...
#define SPI_LL_REG_BASE(_id) \
	((_id) == 0 ? SOC_SPI_REG_BASE : \
	 (_id) == 1 ? SOC_SPI1_REG_BASE : \
	 (_id) == 2 ? SOC_SPI2_REG_BASE : \
	 (_id) == 3 ? SOC_SPI3_REG_BASE : \
	 SOC_SPI_REG_BASE)

#if 0
#define SPI0_LL_CSN_PIN     GPIO_49
#define SPI0_LL_SCK_PIN     GPIO_48
#define SPI0_LL_MOSI_PIN    GPIO_51
#define SPI0_LL_MISO_PIN    GPIO_50
#else
...
#define SPI2_LL_CSN_PIN     GPIO_45
#define SPI2_LL_SCK_PIN     GPIO_44
#define SPI2_LL_MOSI_PIN    GPIO_46
#define SPI2_LL_MISO_PIN    GPIO_47

//need to adapt to the actual pin for SPI3
#define SPI3_LL_CSN_PIN     GPIO_45
#define SPI3_LL_SCK_PIN     GPIO_44
#define SPI3_LL_MOSI_PIN    GPIO_46
#define SPI3_LL_MISO_PIN    GPIO_47
