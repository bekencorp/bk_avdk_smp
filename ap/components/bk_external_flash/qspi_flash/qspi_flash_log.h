...
/* Local logging macros for the QSPI flash/NAND engines that now live in
 * bk_external_flash. Kept identical to the "qspi" tag used by the QSPI driver so
 * existing log output is unchanged after the move out of middleware. */
