...
/* ZBit ZB35Q01CYIG: 1Gbit (128MB), 2KB page, 64 pages/block. JEDEC ID 5Eh C1h. */
const qspi_nand_dev_t qspi_nand_zb35q01_dev = {
	.name = "ZB35Q01CYIG",
	.id = {0x5E, 0xC1},
	.id_len = 2,
	.geometry = {
		.total_size = 128U * 1024U * 1024U,
		.page_size = 2048U,
		.spare_size = 64U,
		.pages_per_block = 64U,
	},
...
QSPI_NAND_DEVICE_SECTION(qspi_nand_zb35q01_dev);
