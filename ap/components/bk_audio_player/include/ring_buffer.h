...
/* The bk_audio_player ships its own private ring buffer implementation whose
 * public API (rb_create/rb_read/...) collides at link time with the ADK
 * audio_pipeline ring buffer (audio_pipeline/ringbuf.c), which exports the
 * same symbol names with different signatures. To keep this private module
 * self-contained on bk7259 (stricter toolchain links all component objects),
 * give every public symbol a unique prefix. Only the bk_audio_player sources
 * that include this header are affected; ADK code includes its own ringbuf.h
 * and is left untouched. */
#define rb_create           bk_apl_rb_create
#define rb_destroy          bk_apl_rb_destroy
#define rb_abort            bk_apl_rb_abort
#define rb_reset            bk_apl_rb_reset
#define rb_bytes_available  bk_apl_rb_bytes_available
#define rb_bytes_filled     bk_apl_rb_bytes_filled
#define rb_get_size         bk_apl_rb_get_size
#define rb_read             bk_apl_rb_read
#define rb_write            bk_apl_rb_write
#define rb_done_write       bk_apl_rb_done_write
#define rb_unblock_reader   bk_apl_rb_unblock_reader
#define rb_is_full          bk_apl_rb_is_full
#define rb_is_done_write    bk_apl_rb_is_done_write
