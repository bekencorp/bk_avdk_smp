...
static const lcd_qspi_init_cmd_t jd9853_init_cmds[] =
{
    ...
    {0xDE, {0x00}, 1},
    {0xB2, {0x25}, 1},
    {0xB7, {0x00, 0x29, 0x00, 0x51}, 4},
    {0xBB, {0x4F, 0x1A, 0x55, 0x73, 0x63, 0xF0}, 6},
    {0xC0, {0x44, 0xA4}, 2},
    {0xC1, {0x12}, 1},
    {0xC3, {0x7D, 0x07, 0x14, 0x06, 0xC8, 0x71, 0x6C, 0x77}, 8},
    {0xC4, {0x00, 0x00, 0x94, 0x79, 0x25, 0x0A, 0x16, 0x79, 0x25, 0x0A, 0x16, 0x82}, 12},
    {0xC8, {0x3F, 0x32, 0x2A, 0x22, 0x26, 0x25, 0x1E, 0x1E, 0x1C, 0x1C, 0x19, 0x0E, 0x09, 0x02, 0x06, 0x00, 0x3F, 0x32, 0x2A, 0x22, 0x26, 0x25, 0x1E, 0x1E, 0x1C, 0x1C, 0x19, 0x0E, 0x09, 0x02, 0x06, 0x00}, 32},
