...
#define LCD_QSPI_ST77903_WX20114_REGISTER_WRITE_COMMAND     0xDE
#define LCD_QSPI_ST77903_WX20114_REGISTER_READ_COMMAND      0xDD
#define LCD_QSPI_ST77903_WX20114_HSYNC_COMMAND              0x60
#define LCD_QSPI_ST77903_WX20114_VSYNC_COMMAND              0x61
#define LCD_QSPI_ST77903_WX20114_VSW        (1)
#define LCD_QSPI_ST77903_WX20114_HFP        (4)
#define LCD_QSPI_ST77903_WX20114_HBP        (4)


static const lcd_qspi_init_cmd_t st77903_wx20114_init_cmds[] =
{
	{0xf0, {0xc3}, 1},
	{0xf0, {0x96}, 1},
	{0xf0, {0xa5}, 1},
...
static const lcd_qspi_t lcd_qspi_st77903_wx20114_config =
{
	...
	.reg_write_cmd = LCD_QSPI_ST77903_WX20114_REGISTER_WRITE_COMMAND,
	.reg_read_cmd = LCD_QSPI_ST77903_WX20114_REGISTER_READ_COMMAND,
	.reg_read_config.dummy_clk = 0,
	.reg_read_config.dummy_mode = LCD_QSPI_NO_INSERT_DUMMMY_CLK,
	.pixel_write_config.cmd = st77903_wx20114_cmd,
	.pixel_write_config.cmd_len = sizeof(st77903_wx20114_cmd),
	.init_cmd = st77903_wx20114_init_cmds,
	.device_init_cmd_len = sizeof(st77903_wx20114_init_cmds) / sizeof(lcd_qspi_init_cmd_t),

	.refresh_config.hsync_cmd = LCD_QSPI_ST77903_WX20114_HSYNC_COMMAND,
	.refresh_config.vsync_cmd = LCD_QSPI_ST77903_WX20114_VSYNC_COMMAND,
	.refresh_config.vsw = LCD_QSPI_ST77903_WX20114_VSW,
	.refresh_config.hfp = LCD_QSPI_ST77903_WX20114_HFP,
	.refresh_config.hbp = LCD_QSPI_ST77903_WX20114_HBP,
	.refresh_config.line_len = 400 * CONFIG_LCD_QSPI_COLOR_DEPTH_BYTE,
	.frame_len = 400 * 400 * CONFIG_LCD_QSPI_COLOR_DEPTH_BYTE,
};

//st77903 screen without display ram, and need to send data continuously.
const bk_display_qspi_panel_t lcd_device_st77903_wx20114 =
{
