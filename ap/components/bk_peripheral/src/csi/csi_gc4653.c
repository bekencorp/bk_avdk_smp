...
// #define GC4653_DGAIN_1			0xB1
// #define GC4653_DGAIN_2			0xB2
// #define GC4653_AGAIN_1			0xB3
// #define GC4653_AGAIN_2			0xB4
// #define GC4653_AGAIN_3			0xB8
// #define GC4653_AGAIN_4			0xB9

//to do 
// const uint8_t gc4653_regValTable[29][4] = {
...
#define GC4653_VMAX_720P30_LINEAR (1125)
...
static int GC4653_InitRegInfo(ISP_PORT IspPort)
{
	...
	// pSnsRegsInfo->snsData[REG_DGAIN_1].regAddr = GC4653_DGAIN_1;
	// pSnsRegsInfo->snsData[REG_DGAIN_2].delayFrameNum = 2;
	// pSnsRegsInfo->snsData[REG_DGAIN_2].regAddr = GC4653_DGAIN_2;
