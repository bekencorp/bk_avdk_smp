...
avdk_err_t ov2640_detect(bk_camera_sensor_handle_t *handle, bk_camera_sensor_config_t *config)
{
...
int ov2640_init(bk_camera_sensor_ctlr_t *controller)
{
...
int ov2640_set_ppi(bk_camera_sensor_ctlr_t *controller, uint16_t width, uint16_t height)
{
    uint32_t size, i;
    int ret = -1;
...
int ov2640_set_fps(bk_camera_sensor_ctlr_t *controller, uint16_t fps)
{
    int ret = -1;
