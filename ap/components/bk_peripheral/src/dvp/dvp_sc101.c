...
avdk_err_t SC101_detect(bk_camera_sensor_handle_t *handle, bk_camera_sensor_config_t *config)
{
...
int SC101_init(bk_camera_sensor_ctlr_t *controller)
{
...
int SC101_set_ppi(bk_camera_sensor_ctlr_t *controller, uint16_t width, uint16_t height)
{
    return 0;
}


int SC101_set_fps(bk_camera_sensor_ctlr_t *controller, uint16_t fps)
{
...
int SC101_reset(bk_camera_sensor_ctlr_t *controller)
{
    return 0;
}
