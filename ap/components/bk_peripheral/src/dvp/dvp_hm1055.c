...
avdk_err_t hm1055_detect(bk_camera_sensor_handle_t *handle, bk_camera_sensor_config_t *config)
{
    uint8_t data[2] = {0};
...
int hm1055_init(bk_camera_sensor_ctlr_t *controller)  
{
...
int hm1055_set_ppi(bk_camera_sensor_ctlr_t *controller, uint16_t width, uint16_t height)
{
    return 0;
}

int hm1055_set_fps(bk_camera_sensor_ctlr_t *controller, uint16_t fps)
{
    uint32_t size, i;
    int ret = -1;
...
int hm1055_power_down(bk_camera_sensor_ctlr_t *controller)
{
