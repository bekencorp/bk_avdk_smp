...
//Note!!! ecdsa Using hardware acceleration, need to be defined MBEDTLS_ECDSA_VERIFY_ALT and MBEDTLS_ECDSA_SIGN_ALT
	...
	CLI_LOGD("mbedtls_sha 1/256/512\r\n");
	CLI_LOGD("mbedtls_ecdsa test 0/1 loop_count\r\n");
	CLI_LOGD("mbedtls_aes ccm/gcm/test 0/1\r\n");
	CLI_LOGD("mbedtls_rsa pkcs1v15/pss\r\n");
	CLI_LOGD("mbedtls_hkdf test 0/1 type okm_size\r\n");
	CLI_LOGD("mbedtls_pkcs5 test 0/1 type loop length\r\n");
}
