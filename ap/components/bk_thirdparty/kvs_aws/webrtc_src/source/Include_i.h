...
#else
/* libsrtp in this SDK is built from libsrtp/include/srtp.h (multi-arg protect/unprotect).
...
/* On Beken, posix/signal.h already included via CommonDefs->pthread.h->time.h; skip <signal.h> to avoid toolchain redefinition of union sigval. */
#include <signal.h>
#endif
#include <sys/types.h>
