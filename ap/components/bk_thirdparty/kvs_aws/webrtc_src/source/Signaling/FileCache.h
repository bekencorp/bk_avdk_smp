...
/* Default 32 for desktop; embedded can override with KVS_SIGNALING_CACHE_ENTRY_COUNT (e.g. 1 or 4) to save RAM. */
#ifndef CONFIG_KVS_SIGNALING_CACHE_ENTRY_COUNT
#define KVS_SIGNALING_CACHE_ENTRY_COUNT 32
#else
#define KVS_SIGNALING_CACHE_ENTRY_COUNT CONFIG_KVS_SIGNALING_CACHE_ENTRY_COUNT
#endif
#define MAX_SIGNALING_CACHE_ENTRY_COUNT           (KVS_SIGNALING_CACHE_ENTRY_COUNT)
