...
STATUS jitterBufferPush(PJitterBuffer pJitterBuffer, PRtpPacket pRtpPacket, PBOOL pPacketDiscarded)
{
    ...
    if (withinLatencyTolerance(pJitterBuffer, pRtpPacket)) {
        ...
        pCurPacket = (PRtpPacket)(uintptr_t) hashValue;
        ...
        CHK_STATUS(hashTablePut(pJitterBuffer->pPkgBufferHashTable, pRtpPacket->header.sequenceNumber, (UINT64)(uintptr_t) pRtpPacket));
