...
/* Beken/Armino: use platform types first to avoid redefinition when this header
...
#if defined(BEKEN_PLATFORM)
/* UINT8..INT64, BOOL, VOID from <common/bk_typedef.h> */
#ifndef CHAR
typedef char CHAR;
#endif
#ifndef WCHAR
...
#define INVALID_TID_VALUE ((UINT64) 0)
#endif
...
#define INVALID_MUTEX_VALUE ((UINT64) 0)
#endif
...
/* POSIX headers: skip on Windows and on bare-metal/newlib (e.g. arm-none-eabi) */
#if !(defined _WIN32 || defined _WIN64) && !defined(__NEWLIB__)
#include <unistd.h>
#include <dirent.h>
#include <sys/time.h>
...
#if !defined(__MACH__) && !defined(__NEWLIB__)
#include <sys/prctl.h>
#endif
...
PUBLIC_API UINT64 defaultGetRealTime();
//
...
#define INVALID_PIC_HANDLE_VALUE ((UINT64) 0)
#endif
