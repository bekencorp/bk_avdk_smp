...
#define TO_TIMER_QUEUE_HANDLE(p)   ((TIMER_QUEUE_HANDLE)(uintptr_t)(p))
#define FROM_TIMER_QUEUE_HANDLE(h) (IS_VALID_TIMER_QUEUE_HANDLE(h) ? (PTimerQueue)(uintptr_t)(h) : NULL)
...
// Public handle to and from object converters
#define TO_SEMAPHORE_HANDLE(p)   ((SEMAPHORE_HANDLE)(uintptr_t)(p))
#define FROM_SEMAPHORE_HANDLE(h) (IS_VALID_SEMAPHORE_HANDLE(h) ? (PSemaphore)(uintptr_t)(h) : NULL)
