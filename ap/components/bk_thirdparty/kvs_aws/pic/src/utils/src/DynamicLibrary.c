...
#if defined _WIN32 || defined _WIN64 || defined __CYGWIN__ || defined __NEWLIB__
//
// Stub dynamic library loading functions (Windows and embedded platforms
// without dynamic linking support, e.g. newlib/7259)
//
