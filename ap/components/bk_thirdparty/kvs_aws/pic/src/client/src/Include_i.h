 ...
 */
#define TO_CLIENT_HANDLE(p)   ((CLIENT_HANDLE)(uintptr_t)(p))
#define FROM_CLIENT_HANDLE(h) (IS_VALID_CLIENT_HANDLE(h) ? (PKinesisVideoClient)(uintptr_t)(h) : NULL)

#define TO_STREAM_HANDLE(p)   (toStreamHandle(p))
#define FROM_STREAM_HANDLE(h) (fromStreamHandle(h))

#define TO_CUSTOM_DATA(p)          ((UINT64)(uintptr_t)(p))
#define STREAM_FROM_CUSTOM_DATA(h) ((PKinesisVideoStream)(uintptr_t)(h))
#define CLIENT_FROM_CUSTOM_DATA(h) ((PKinesisVideoClient)(uintptr_t)(h))

#define KINESIS_VIDEO_OBJECT_IDENTIFIER_FROM_CUSTOM_DATA(h) ((UINT32)*(PUINT32)(uintptr_t)(h))
