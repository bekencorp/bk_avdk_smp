...
#define TRACE_PROFILER_HANDLE_TO_POINTER(h) (IS_VALID_TRACE_PROFILER_HANDLE(h) ? (PTraceProfiler)(uintptr_t)(h) : NULL)
#endif

#ifndef TRACE_HANDLE_TO_POINTER
#define TRACE_HANDLE_TO_POINTER(h) ((PTrace)(uintptr_t)(h))
#endif
