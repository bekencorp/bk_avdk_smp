...
#define MAX_RX_FIFO_SIZE 1024
#define USBH_MAX_ISOC_TRANSACTIONS_PER_UFRAME 1U
#define USBH_MAX_ISOC_MPS_PER_TRANSACTION    1024U
...
bk_err_t bk_usbh_hub_port_video_open_handle(bk_usb_hub_port_info *port_dev_info)
{
	...
	USB_HUB_MD_LOGD("Selecting altsetting: mult=0 only, pick largest mps, hw_limit=%u x %u bytes\r\n",
