 ...
 * by ^0xFFFFFFFF). Use this for the AB ping-pong flag record so AP/CP match the
 * packager-provisioned CRC.
 *
 * @param crc     initial value; pass 0 for a fresh computation (chainable)
 * @param inSrc   input data
 * @param inLen   length of input data
 * @retval        the CRC32 over the data
 */
