...
#define ISP_MP_LINE_START() do {GPIO_UP(1); } while (0);
...
#define GPU_FRAME_START() do {GPIO_UP(8); } while (0);
#define GPU_FRAME_END() do { GPIO_DOWN(8); } while (0);
#define GPU_LINE_START() do {GPIO_UP(9); } while (0);
...
#define DPU_VIDEO_FRAME_START() do {GPIO_UP(15); } while (0);
#define DPU_VIDEO_FRAME_END() do { GPIO_DOWN(15); } while (0);
#define DPU_VIDEO_ISR_START() do {GPIO_UP(16); } while (0);
#define DPU_VIDEO_ISR_END() do { GPIO_DOWN(16); } while (0);
#define DPU_GRAPHIC_FRAME_START() //do { GPIO_DOWN(11); GPIO_UP(11); } while (0);
#define DPU_GRAPHIC_FRAME_END() //do { GPIO_DOWN(11); } while (0);
#define DPU_GRAPHIC_ISR_START() //do {GPIO_UP(20); } while (0);
...
#define DECODE_FRAME_START      do {GPIO_UP(34); } while (0);
#define DECODE_FRAME_END        do { GPIO_DOWN(34); } while (0);
#define DECODE_LINE_START       do {GPIO_UP(35); } while (0);
...
#define ENCODE_FRAME_START      do {GPIO_UP(37); } while (0);
