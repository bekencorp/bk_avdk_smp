...
bk_err_t adk_mp3_decoder_test_case_0(void)
{
    ...
    while (1)
    {
        ...
        if (msg.source == (void *) mp3_dec && msg.cmd == AEL_MSG_CMD_REPORT_MUSIC_INFO)
        {
            ...
            onboard_speaker_stream_set_param(speaker_stream, music_info.sample_rates, music_info.bits, music_info.channels, AUD_DAC_SOURCE_A2DP);
            #else
...
bk_err_t adk_mp3_decoder_test_case_1(char *file_path)
{
    ...
    {
        speaker_cfg.sample_rate[i] = 44100;
    }
    #else
    ...
    while (1)
    {
        ...
        if (msg.source == (void *) mp3_dec && msg.cmd == AEL_MSG_CMD_REPORT_MUSIC_INFO)
        {
            ...
            onboard_speaker_stream_set_param(speaker_stream, music_info.sample_rates,
                                            music_info.bits, music_info.channels, AUD_DAC_SOURCE_A2DP);
            #else
            onboard_speaker_stream_set_param(speaker_stream, music_info.sample_rates, 
