...
#ifndef BLE_USE_STORAGE
#ifdef CONFIG_BLUETOOTH_BTDM_COMPONENT_BLE_USE_STORAGE
#define BLE_USE_STORAGE CONFIG_BLUETOOTH_BTDM_COMPONENT_BLE_USE_STORAGE
#else
#define BLE_USE_STORAGE 1
#endif
#endif

#ifndef GATTS_TEST_ATTR_ENABLE
#ifdef CONFIG_BLUETOOTH_BTDM_COMPONENT_BLE_GATTS_TEST_ATTR
#define GATTS_TEST_ATTR_ENABLE CONFIG_BLUETOOTH_BTDM_COMPONENT_BLE_GATTS_TEST_ATTR
#else
