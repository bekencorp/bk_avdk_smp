...
extern bool bk_modem_dce_save_settings(void);
extern bool bk_modem_dce_cereg_enable(void);
extern bool bk_modem_dce_cereg_enable_with_loc(void);
...
extern bool bk_modem_dce_ec_sclkex_set(void);