...
class bk_packager_format_linker(bk_packager_linker):
    ...
    def _gen_img_header(self, part_item:PartitionInfo, part_type):
        ...
        img_header += struct.pack('>I', self.crc_handler.crc_data(part_item.data)) # checksum
