...
function(__kconfig_generate_config sdkconfig sdkconfig_defaults sdkconfig_default_soc)
    ...
    # Look for a per-project diff defconfig at the canonical source location
    # (not derived from sdkconfig dir, which may be a build output path).
    get_filename_component(sub_sys ${armino_path} NAME)
    set(project_diff_config "${CMAKE_SOURCE_DIR}/${sub_sys}/config/${armino_target}/defconfig")
    if(EXISTS "${project_diff_config}")
        list(APPEND defaults_arg --defaults "${project_diff_config}")
    endif()
