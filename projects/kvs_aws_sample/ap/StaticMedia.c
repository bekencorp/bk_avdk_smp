...
#else
            SNPRINTF(filePath, MAX_PATH_LEN, SAMPLE_MEDIA_ROOT "/h264SampleFrames/frame-%04d.h264", fileIndex);
#endif
...
#else
            SNPRINTF(filePath, MAX_PATH_LEN, SAMPLE_MEDIA_ROOT "/h265SampleFrames/frame-%04d.h265", fileIndex);
#endif
        }
...
#else
            SNPRINTF(filePath, MAX_PATH_LEN, SAMPLE_MEDIA_ROOT "/opusSampleFrames/sample-%03d.opus", fileIndex);
#endif
        }
...
#else
            CHK_STATUS(readFrameFromDisk(NULL, &frameSize, SAMPLE_MEDIA_ROOT "/h264SampleFrames/frame-0001.h264"));
#endif
...
#else
            CHK_STATUS(readFrameFromDisk(NULL, &frameSize, SAMPLE_MEDIA_ROOT "/h265SampleFrames/frame-0001.h265"));
#endif
...
#else
            CHK_STATUS(readFrameFromDisk(NULL, &frameSize, SAMPLE_MEDIA_ROOT "/opusSampleFrames/sample-001.opus"));
#endif
