...
extern void cli_mjpeg_decode_stress_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
...
static const struct cli_command s_h264_decode_commands[] =
{
    ...
    {"mjpeg_decode_stress", "mjpeg_decode_stress", cli_mjpeg_decode_stress_cmd},
};
