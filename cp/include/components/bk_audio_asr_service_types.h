...
#if CONFIG_ADK_AEC_V3_ALGORITHM_COMPONENT_V1
#include <components/bk_audio/audio_algorithms/aec_v3_algorithm.h>
#elif CONFIG_ADK_AEC_V3_ALGORITHM_COMPONENT_V2
...
#elif CONFIG_ADK_ONBOARD_MIC_STREAM_V2
#include <components/bk_audio/audio_streams/onboard_mic_stream_v2.h>
#endif
#if CONFIG_ASR_SERVICE_WITH_UAC
