...
typedef enum {
	I2S_GPIO_GROUP_0 = 0, /**< I2S gpio group 0: GPIO9,  GPIO10, GPIO11, GPIO12 */
	I2S_GPIO_GROUP_1,     /**< I2S gpio group 1: GPIO13, GPIO14, GPIO15, GPIO16 */
	I2S_GPIO_GROUP_2,     /**< I2S gpio group 2: GPIO17, GPIO18, GPIO19, GPIO20 */
	I2S_GPIO_GROUP_3,     /**< I2S gpio group 3: GPIO21, GPIO22, GPIO23, GPIO24 */
	I2S_GPIO_GROUP_4,     /**< I2S gpio group 4: GPIO25, GPIO26, GPIO27, GPIO28 */
	I2S_GPIO_GROUP_MAX
} i2s_gpio_group_id_t;
#else
typedef enum {
