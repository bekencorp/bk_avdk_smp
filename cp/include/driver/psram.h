...
/**
 * @brief     Init the specified PSRAM instance (PSRAM0/PSRAM1)
 *
 * @param psram_id PSRAM instance id (PSRAM_ID_0 / PSRAM_ID_1)
 *
 * @return
 *    - BK_OK: succeed
 *    - others: other errors.
...
/**
 * @brief     Deinit the specified PSRAM instance (PSRAM0/PSRAM1)
 *
 * @param psram_id PSRAM instance id (PSRAM_ID_0 / PSRAM_ID_1)
 *
 * @return
...
/**
 * @brief     get psram data length
 *
 * This API used to get psram data length
 *
 * @param id:psram chip id
 *
 * @return
 *    - data_length
 */
...
/**
 * @brief     Init psram with specified clock/voltage (legacy CLI helper)
 *
 * @param psram_clk Clock in MHz (80/120/160/240) or psram_clk_t enum value
 * @param psram_vol Voltage in mV (e.g. 1950) or centi-volt (e.g. 195)
 */
...
/**
 * @brief     alloc write_through_area for specified PSRAM instance
 */
...
/**
 * @brief     free write_through_area for specified PSRAM instance
 */
...
/**
 * @brief     Enable and config PSRAM write through area for specified PSRAM instance
 */
...
/**
 * @brief     Disable PSRAM write through area for specified PSRAM instance
 */
