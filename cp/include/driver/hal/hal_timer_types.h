...
typedef enum {
	...
	TIMER_ID15,    /**< TIMER id 15 - temporary NOT SUPPORTED on CP */
	TIMER_ID16,    /**< TIMER id 16 - temporary NOT SUPPORTED on CP */
	TIMER_ID17,    /**< TIMER id 17 - temporary NOT SUPPORTED on CP */
