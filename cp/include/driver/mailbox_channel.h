...
enum
{
	...
	MB_CHNL_HW_CTRL         = CP2_MB_LOG_CHNL_START,
	CP2_MB_CHNL_IPC,  
	MB_CHNL_PWC,
	MB_CHNL_BT_CMD,
	MB_CHNL_WIFI_CMD,
...
{
	/* CPU0 --> CPU3 */
	CP3_MB_LOG_CHNL_START   = CPX_LOG_CHNL_START(SELF_CPU, MAILBOX_CPU3),

	CP3_MB_LOG_CHNL_END,
	CP3_MB_LOG_CHNL_MAX = (CP3_MB_LOG_CHNL_START + LOG_CHNL_ID_MASK), // max 16 channels.
};
