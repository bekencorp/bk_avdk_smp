...
#define BK_ERR_ADC_INSUFFICIENT_MEM              (BK_ERR_ADC_BASE - 12) /**< ADC out of memory */
#define BK_ERR_ADC_DEINIT_MUTEX                  (BK_ERR_ADC_BASE - 13) /**< ADC mutex deinit failed */
#define BK_ERR_ADC_DEINIT_READ_SEMA              (BK_ERR_ADC_BASE - 14) /**< ADC read sync deinit failed */
#define BK_ERR_ADC_DPLL_NOT_SUPPORTED            (BK_ERR_ADC_BASE - 15) /**< ADC DPLL clock source not supported */
