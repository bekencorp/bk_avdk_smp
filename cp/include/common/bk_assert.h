...
void bk_assert_handler(const char *, const int);
#define BK_ASSERT_DUMP(func, line)   bk_assert_handler(func, line)
#else
...
#define BK_TRACEBACK()  do{ bk_traceback();asm volatile("" ::: "memory"); } while (0)
