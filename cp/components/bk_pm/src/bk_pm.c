...
bk_err_t __attribute__((weak)) bk_pm_module_vote_xtal_rx_tx_anabuf_ctrl(pm_xtal_rx_tx_anabuf_module_name_e module, pm_xtal_rx_tx_anabuf_state_e sleep_state)
{
	LOGD("bk_pm_module_vote_xtal_rx_tx_anabuf_ctrl: module=%d, sleep_state=%d (weak default)\n", module, sleep_state);
	return BK_OK;
}

uint32_t __attribute__((weak)) bk_pm_get_xtal_rx_tx_anabuf_ctrl_state(void)
{
	return 0;
}
