...
//Note that frame is constructed with len + MAC frame
...
#define IEEE802154_FRAME_TYPE_OFFSET            0
...
#define IEEE802154_FRAME_SECURITY_OFFSET        0
...
#define IEEE802154_FRAME_AR_OFFSET              0
#define IEEE802154_FRAME_AR_BIT                 BIT(5)

#define IEEE802154_FRAME_PANID_COMP_OFFSET      0
#define IEEE802154_FRAME_PANID_COMP_BIT         BIT(6)

#define IEEE802154_FRAME_VERSION_OFFSET         1
...
#define IEEE802154_FRAME_DSN_OFFSET             1
#define IEEE802154_FRAME_DSN_BIT                BIT(0)
#define IEEE802154_FRAME_IE_OFFSET              1
...
#define IEEE802154_FRAME_DST_MODE_OFFSET        1
...
#define IEEE802154_FRAME_SRC_MODE_OFFSET        1
...
#define IEEE802154_IMM_ACK_LENGTH               5
 ...
 *
 * @return
 *      - BK_OK if destination PAN ID is present, otherwise BK_FAIL.
 *
 */
bk_err_t ieee802154_frame_get_dest_panid(const uint8_t *frame, uint8_t *panid);
 ...
 *
 * @return
 *      - BK_OK if source PAN ID is present, otherwise BK_FAIL.
 *
 */
bk_err_t ieee802154_frame_get_src_panid(const uint8_t *frame, uint8_t *panid);

bool is_data_request_frame(const uint8_t *frame);
