...
static psa_status_t tfm_crypto_call_srv(const psa_msg_t *msg)
{
    ...
    psa_invec in_vec_pseudo[PSA_MAX_IOVEC] = { {NULL, 0} };
    psa_outvec out_vec_pseudo[PSA_MAX_IOVEC] = { {NULL, 0} };
    ...
    memcpy(in_vec_pseudo, in_vec, PSA_MAX_IOVEC);
    extern bool register_systick_callback(int32_t (*func)(void *,size_t, void *, size_t),
							   void *a0, size_t a1, void *a2, size_t a3);
    extern void unregister_systick_callback(int32_t (*func)(void *,size_t, void *, size_t));
    register_systick_callback((int32_t (*)(void *, size_t, void *, size_t))tfm_crypto_api_dispatcher,
                              (void *)in_vec_pseudo, in_len, (void *)out_vec_pseudo, out_len);
    ...
    unregister_systick_callback((int32_t (*)(void *, size_t, void *, size_t))tfm_crypto_api_dispatcher);
