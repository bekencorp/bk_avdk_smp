...
#if defined(ARM_CE_DUBHE_SCA)
    MBEDTLS_CIPHER_SM4_ECB,              /**< SM4 cipher with ECB mode. */
    MBEDTLS_CIPHER_SM4_CBC,              /**< SM4 cipher with CBC mode. */
    MBEDTLS_CIPHER_SM4_CTR,              /**< SM4 cipher with CTR mode. */
#endif
...
#if defined(ARM_CE_DUBHE_SCA)
/**
 * \brief               This function sets a hardware-derived key to use with
 *                      the given context.
 *
 * \param ctx           The generic cipher context. May not be NULL. Must have
 *                      been initialized using mbedtls_cipher_setup().
 * \param key_type      The derived key type, model key or device root key.
 * \param key1          The first key component to use.
 * \param key2          The second key component to use.
 * \param key3          The third key component to use.
