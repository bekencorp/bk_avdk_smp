...
#define CONFIG_CODE_ENCRYPTED                         1
/* BK7259: flash CRC disabled in hardware -> identity phy<->virtual mapping.
 * (Regenerated by beken_utils gen security from crc_en=FALSE.) */
