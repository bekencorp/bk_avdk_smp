...
//
// NOTE (BK7259): The offsets below are STALE (cloned from bk7239n, e.g.
// BL1 ROTPK@0x128, BL2 ROTPK@0x148). At build time `beken_utils gen all`
// (gen_otp_map_file) REGENERATES this file from the BK7259 board otp1.csv
// (sdk/cp/middleware/boards/bk7259/csv/otp1.csv), where the real layout is
// BL1 ROTPK@0x228, BL2 ROTPK@0x248, OTP APB base 0x42100000.
// The authoritative OTP layout is otp1.csv, not this committed stub.
...
const otp_item_t otp_map_1[34] = {
    {OTP_MEMORY_CHECK_MARK,                   60,    0x0,    OTP_READ_WRITE,    OTP_SECURITY},
    {OTP_EFUSE,                                4,    0x3c,    OTP_READ_WRITE,    OTP_SECURITY},
    {OTP_AES_KEY,                             32,    0x40,    OTP_READ_WRITE,    OTP_SECURITY},
    ...
    {OTP_PROFILE_DEFINITION,                  32,    0x32c,    OTP_READ_WRITE,    OTP_NON_SECURITY},
    ...
    {OTP_GADC_CALIBRATION_EXT,                 4,    0x3d0,    OTP_READ_WRITE,    OTP_NON_SECURITY},
};
