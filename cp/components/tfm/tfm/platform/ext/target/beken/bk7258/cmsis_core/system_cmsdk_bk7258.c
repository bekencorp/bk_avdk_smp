...
#define BK7258_PMU_BASE_ADDR         0x44000000
#define DEEP_SLEEP_RESTART_BIT		(0x1 << 1)
#define BK7258_PMU_RESET_REASON_GET (*((volatile unsigned int *)(BK7258_PMU_BASE_ADDR + 0x0*4)))
#define RUNNING_IS_FROM_DEEP_SLEEP      ((BK7258_PMU_RESET_REASON_GET & DEEP_SLEEP_RESTART_BIT ) != 0)
