 ...
 * Copyright (c)     2023-2028 ArmChina. 
 * All rights reserved.
...
#ifndef SCB_CCR_TRD_Pos
#define SCB_CCR_TRD_Pos                    20U                                            /*!< SCB CCR: TRD Position (Armv8.1-M) */
#define SCB_CCR_TRD_Msk                    (1UL << SCB_CCR_TRD_Pos)                       /*!< SCB CCR: TRD Mask (Armv8.1-M) */
#endif
