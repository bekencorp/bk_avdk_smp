...
/* BK7259: this MCUboot BL2 image-verification public key MUST match the EC-P256
 * private key the secure packer signs primary_all with (beken_utils bl2_sign ->
 * root_ec256_privkey.pem). The psa_level3 stock key here (root-EC-P256.pem,
 * pubkey 489ef5bd...) did NOT match the signing key (2fb9412c...), so MCUboot
 * rejected a perfectly-read image: "Image in the primary slot is not valid!".
 * Regenerated with: imgtool.py getpub -k root_ec256_privkey.pem. */
const unsigned char ecdsa_pub_key[] = {
    0x30, 0x59, 0x30, 0x13, 0x06, 0x07, 0x2a, 0x86,
    0x48, 0xce, 0x3d, 0x02, 0x01, 0x06, 0x08, 0x2a,
    0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07, 0x03,
    0x42, 0x00, 0x04, 0xc7, 0x03, 0x95, 0xcd, 0x21,
    0x3d, 0xa2, 0xe8, 0x6d, 0xaf, 0x37, 0x34, 0x12,
    0x21, 0x2e, 0xae, 0xa0, 0xd5, 0xd8, 0x76, 0x68,
    0xa7, 0xb5, 0x5e, 0xdc, 0xc3, 0xfd, 0xc1, 0x95,
    0xf9, 0xed, 0x75, 0xf3, 0x5b, 0xd3, 0x7b, 0x7a,
    0xc7, 0xa0, 0xd0, 0x78, 0xed, 0xcc, 0x96, 0x25,
    0x58, 0x36, 0xd7, 0x8e, 0x9c, 0xa4, 0x58, 0x01,
    0xb8, 0xb8, 0xa7, 0x04, 0x7c, 0x12, 0xd0, 0x3e,
    0x0d, 0xff, 0xdb,
};
