...
/* BK7259: the Dubhe HW accelerator path enables MBEDTLS_RSA_C, whose
 * prerequisite MBEDTLS_OID_C is not on in the stock profile_medium config.
 * Enable OID_C to satisfy mbedtls check_config.h. Harmless if RSA is unused. */
