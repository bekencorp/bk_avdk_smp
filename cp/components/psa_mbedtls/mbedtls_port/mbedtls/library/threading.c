...
void (*mbedtls_mutex_init)(mbedtls_threading_mutex_t *) = bk_threading_mutex_init_freertos;
void (*mbedtls_mutex_free)(mbedtls_threading_mutex_t *) = bk_threading_mutex_free_freertos;
int (*mbedtls_mutex_lock)(mbedtls_threading_mutex_t *) = bk_threading_mutex_lock_freertos;
int (*mbedtls_mutex_unlock)(mbedtls_threading_mutex_t *) = bk_threading_mutex_unlock_freertos;
