...
extern void *bk_wrap_sram_malloc_cm(const char *call_func_name, int line, size_t xWantedSize, int need_zero);
extern void *pvPortMalloc_cm(const char *call_func_name, int line, size_t xWantedSize, int need_zero);
extern void *vPortFree_cm(const char *call_func_name, int line, void *pv);
