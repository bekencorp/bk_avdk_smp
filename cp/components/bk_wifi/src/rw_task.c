...
#if CONFIG_SOC_SMP
	os_ret = rtos_core0_create_thread(&g_wifi_core.handle,
...
#if CONFIG_PM_V2 && CONFIG_STA_PS && (CONFIG_SOC_BK7256XX || CONFIG_SOC_BK7236XX || CONFIG_SOC_BK7239XX || CONFIG_SOC_BK7286XX || CONFIG_SOC_BK7259)
	if (!ate_is_enabled())
	{
		rwnxl_sleep();
