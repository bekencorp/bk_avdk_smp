...
#error "Select the exact/right core type"
#endif
...
#define PWRMODCTL_CPDLPSTATE_ELPSTATE_Pos   4U                                              /*!< PWRMODCTL CPDLPSTATE: ELPSTATE (PDEPU) Position */
