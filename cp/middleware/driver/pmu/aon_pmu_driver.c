...
uint32_t aon_pmu_drv_get_td_caldone_mode1(void)
{
	return aon_pmu_hal_get_td_caldone_mode1();
}
...
uint32_t aon_pmu_drv_band_cal_get()
{
...
void aon_pmu_drv_set_wlp_power_down(uint32_t v)
{
	uint32_t int_level = sys_drv_enter_critical();

	aon_pmu_hal_set_wlp_power_down(v);
