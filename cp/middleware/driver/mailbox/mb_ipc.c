...
#define IPC_CPU3_BIT		(0x01 << (MAILBOX_CPU3))
...
#define IPC_MB_LOG_CHNL CP2_MB_CHNL_IPC
#else
#define IPC_MB_LOG_CHNL CP1_MB_CHNL_IPC
#endif

static mb_ipc_route_t   __attribute__((section(".dtcm_sec_data")))  ipc_route_tbl[] = 
	{
		{.dst_cpus = (IPC_CPU2_BIT), .log_chnl = IPC_MB_LOG_CHNL, 
