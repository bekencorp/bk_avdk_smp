...
static void spi_clock_enable(spi_id_t id)
{
	...
	{
		case SPI_ID_0:
			sys_drv_dev_clk_pwr_up(CLK_PWR_ID_SPI0, CLK_PWR_CTRL_PWR_UP);
			break;
#if (SOC_SPI_UNIT_NUM > 1)
		case SPI_ID_1:
...
static void spi_clock_disable(spi_id_t id)
{
	...
	{
		case SPI_ID_0:
			sys_drv_dev_clk_pwr_up(CLK_PWR_ID_SPI0, CLK_PWR_CTRL_PWR_DOWN);
			break;
#if (SOC_SPI_UNIT_NUM > 1)
		case SPI_ID_1:
			sys_drv_dev_clk_pwr_up(CLK_PWR_ID_SPI1, CLK_PWR_CTRL_PWR_DOWN);
			break;
#endif
#if (SOC_SPI_UNIT_NUM > 2)
		case SPI_ID_2:
			sys_drv_dev_clk_pwr_up(CLK_PWR_ID_SPI2, CLK_PWR_CTRL_PWR_DOWN);
			break;
#endif
#if (SOC_SPI_UNIT_NUM > 3)
		case SPI_ID_3:
			sys_drv_dev_clk_pwr_up(CLK_PWR_ID_SPI3, CLK_PWR_CTRL_PWR_DOWN);
			break;
#endif
		default:
			break;
