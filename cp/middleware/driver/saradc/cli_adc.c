...
static const struct cli_command s_adc_commands[] = {
	{"cp_sadc_driver", "sadc_driver [init/deinit]", cli_adc_driver_cmd},
	{"cp_sadc", "sadc  [channel] [start/stop/dump_statis]", cli_adc_cmd},
	{"cp_sadc_api_test", "sadc_api_test []", cli_adc_api_cmd},
