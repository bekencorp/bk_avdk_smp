...
{
	bk_pm_clock_ctrl(PM_CLK_ID_LIN0, CLK_PWR_CTRL_PWR_UP);
...
{
	bk_pm_clock_ctrl(PM_CLK_ID_LIN0, CLK_PWR_CTRL_PWR_DOWN);
...
{
	sys_drv_set_int_en(CPU0_CORE_ID, INT_SRC_LIN, 1);
...
{
	sys_drv_set_int_en(CPU0_CORE_ID, INT_SRC_LIN, 0);
