...
DRV_CLI_CMD_EXPORT static const struct cli_command s_wdt_api_commands[] = {
...
int bk_wdt_register_cli_api_test_feature(void)
{
    return cli_register_module_test_feature(s_wdt_api_commands, WDT_CMD_CNT);
}
// eof
