...
- **资源 0-15**：使用 `BK_HSPL_ID_0` (CP) 的通道 0-15（**CP可用**）
- **资源 16-31**：使用 `BK_HSPL_ID_1` (AP) 的通道 0-15（**CP不可用**，仅AP SMP）

#### CP侧可用资源（0-15）

| 资源ID | 资源名称 | HSPL 实例 | 通道 |
|--------|---------|-----------|------|
| 0 | FLASH | BK_HSPL_ID_0 (CP) | 0 |
| 1 | CLOCK | BK_HSPL_ID_0 (CP) | 1 |
| 2 | POWER | BK_HSPL_ID_0 (CP) | 2 |
| 3 | SYS | BK_HSPL_ID_0 (CP) | 3 |
| 4 | RTC | BK_HSPL_ID_0 (CP) | 4 |
| 5 | ANA | BK_HSPL_ID_0 (CP) | 5 |
| 6 | FUSE | BK_HSPL_ID_0 (CP) | 6 |
| 7 | TRNG | BK_HSPL_ID_0 (CP) | 7 |
| 8 | WDT | BK_HSPL_ID_0 (CP) | 8 |
| 9 | SPI | BK_HSPL_ID_0 (CP) | 9 |
| 10 | GPIO | BK_HSPL_ID_0 (CP) | 10 |
| 11 | PWM | BK_HSPL_ID_0 (CP) | 11 |
| 12 | ADC | BK_HSPL_ID_0 (CP) | 12 |
| 13 | DAC | BK_HSPL_ID_0 (CP) | 13 |
| 14 | PMU | BK_HSPL_ID_0 (CP) | 14 |
| 15 | USER0 | BK_HSPL_ID_0 (CP) | 15 |
