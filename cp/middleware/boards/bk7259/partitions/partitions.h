...
/* TrustZone secure-boot layout: CP NS app XIP is in primary_cpu0_app. */
#if defined(CONFIG_PRIMARY_CPU0_APP_VIRTUAL_CODE_START)
#undef CONFIG_CP_VIRTUAL_PARTITION_OFFSET
#undef CONFIG_CP_VIRTUAL_PARTITION_SIZE
#define CONFIG_CP_VIRTUAL_PARTITION_OFFSET          CONFIG_PRIMARY_CPU0_APP_VIRTUAL_CODE_START
#define CONFIG_CP_VIRTUAL_PARTITION_SIZE            CONFIG_PRIMARY_CPU0_APP_VIRTUAL_CODE_SIZE
#endif
