...
/* REG_0x03:reg_0x3->int_status_chn3:3,ch3 中断状态 0：无中断。  1： 有中断,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x3_int_status_chn3(mbox0_hw_t *hw)
{
    return hw->reg_0x3.int_status_chn3;
}
...
static inline uint32_t mbox0_ll_get_reg_0x40_value(mbox0_hw_t *hw)
{
    return hw->reg_0x40.v;
}

static inline void mbox0_ll_set_reg_0x40_value(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.v = value;
}

/* REG_0x40:reg_0x40->fifo_start:5:0,chn2的fifo起始地址,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x40_fifo_start(mbox0_hw_t *hw)
{
    return hw->reg_0x40.fifo_start;
}

/* REG_0x40:reg_0x40->fifo_start:5:0,chn2的fifo起始地址,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x40_fifo_start(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.fifo_start = value;
}

/* REG_0x40:reg_0x40->int_en:8,1: chn2 int enable 0: chn2 int disable,0x1,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x40_int_en(mbox0_hw_t *hw)
{
    return hw->reg_0x40.int_en;
}

/* REG_0x40:reg_0x40->int_en:8,1: chn2 int enable 0: chn2 int disable,0x1,R/W*/
static inline void mbox0_ll_set_reg_0x40_int_en(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.int_en = value;
}

/* REG_0x40:reg_0x40->int_wrerr_en:9,1:写异常中断使能    0：写异常中断不使能,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x40_int_wrerr_en(mbox0_hw_t *hw)
{
    return hw->reg_0x40.int_wrerr_en;
}

/* REG_0x40:reg_0x40->int_wrerr_en:9,1:写异常中断使能    0：写异常中断不使能,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x40_int_wrerr_en(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.int_wrerr_en = value;
}

/* REG_0x40:reg_0x40->int_rderr_en:10,1:读异常中断使能    0：读异常中断不使能,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x40_int_rderr_en(mbox0_hw_t *hw)
{
    return hw->reg_0x40.int_rderr_en;
}

/* REG_0x40:reg_0x40->int_rderr_en:10,1:读异常中断使能    0：读异常中断不使能,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x40_int_rderr_en(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.int_rderr_en = value;
}

/* REG_0x40:reg_0x40->int_wrfull_en:11,1:写满异常中断使能  0：写满异常中断不使能,0x1,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x40_int_wrfull_en(mbox0_hw_t *hw)
{
    return hw->reg_0x40.int_wrfull_en;
}

/* REG_0x40:reg_0x40->int_wrfull_en:11,1:写满异常中断使能  0：写满异常中断不使能,0x1,R/W*/
static inline void mbox0_ll_set_reg_0x40_int_wrfull_en(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.int_wrfull_en = value;
}

/* REG_0x40:reg_0x40->wrerr_int_sta:16,写异常中断状态   ，写1清。被非法通道写入mail_tid置1或tid越界置1,0x0,R/W1C*/
static inline uint32_t mbox0_ll_get_reg_0x40_wrerr_int_sta(mbox0_hw_t *hw)
{
    return hw->reg_0x40.wrerr_int_sta;
}

/* REG_0x40:reg_0x40->wrerr_int_sta:16,写异常中断状态   ，写1清。被非法通道写入mail_tid置1或tid越界置1,0x0,R/W1C*/
static inline void mbox0_ll_set_reg_0x40_wrerr_int_sta(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.wrerr_int_sta = value;
}

/* REG_0x40:reg_0x40->rderr_int_sta:17,读异常中断状态   ，写1清。被非法通道读取mail_sid置1,0x0,R/W1C*/
static inline uint32_t mbox0_ll_get_reg_0x40_rderr_int_sta(mbox0_hw_t *hw)
{
    return hw->reg_0x40.rderr_int_sta;
}

/* REG_0x40:reg_0x40->rderr_int_sta:17,读异常中断状态   ，写1清。被非法通道读取mail_sid置1,0x0,R/W1C*/
static inline void mbox0_ll_set_reg_0x40_rderr_int_sta(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.rderr_int_sta = value;
}

/* REG_0x40:reg_0x40->wrfull_int_sta:18,写满异常中断状态 ，写1清。向满fifo写入置1,0x0,R/W1C*/
static inline uint32_t mbox0_ll_get_reg_0x40_wrfull_int_sta(mbox0_hw_t *hw)
{
    return hw->reg_0x40.wrfull_int_sta;
}

/* REG_0x40:reg_0x40->wrfull_int_sta:18,写满异常中断状态 ，写1清。向满fifo写入置1,0x0,R/W1C*/
static inline void mbox0_ll_set_reg_0x40_wrfull_int_sta(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x40.wrfull_int_sta = value;
}

/* REG_0x40:reg_0x40->fifo_noempt:19,0:fifo 空  1： fifo非空,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x40_fifo_noempt(mbox0_hw_t *hw)
{
    return hw->reg_0x40.fifo_noempt;
}

/* REG_0x41 */

static inline uint32_t mbox0_ll_get_reg_0x41_value(mbox0_hw_t *hw)
{
    return hw->reg_0x41.v;
}

static inline void mbox0_ll_set_reg_0x41_value(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x41.v = value;
}

/* REG_0x41:reg_0x41->chn_enable:0,使能信号,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x41_chn_enable(mbox0_hw_t *hw)
{
    return hw->reg_0x41.chn_enable;
}

/* REG_0x41:reg_0x41->chn_enable:0,使能信号,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x41_chn_enable(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x41.chn_enable = value;
}

/* REG_0x41:reg_0x41->fifo_length:6:1,chn2的fifo的深度,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x41_fifo_length(mbox0_hw_t *hw)
{
    return hw->reg_0x41.fifo_length;
}

/* REG_0x41:reg_0x41->fifo_length:6:1,chn2的fifo的深度,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x41_fifo_length(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x41.fifo_length = value;
}

/* REG_0x42 */

static inline uint32_t mbox0_ll_get_reg_0x42_value(mbox0_hw_t *hw)
{
    return hw->reg_0x42.v;
}

static inline void mbox0_ll_set_reg_0x42_value(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x42.v = value;
}

/* REG_0x42:reg_0x42->mail_tdata0:31:0,向tid发送的数据tdata0,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x42_mail_tdata0(mbox0_hw_t *hw)
{
    return hw->reg_0x42.v;
}

/* REG_0x42:reg_0x42->mail_tdata0:31:0,向tid发送的数据tdata0,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x42_mail_tdata0(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x42.v = value;
}
...
static inline uint32_t mbox0_ll_get_reg_0x43_value(mbox0_hw_t *hw)
{
    return hw->reg_0x43.v;
}

static inline void mbox0_ll_set_reg_0x43_value(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x43.v = value;
}

/* REG_0x43:reg_0x43->mail_tdata1:31:0,向tid发送的数据tdata1,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x43_mail_tdata1(mbox0_hw_t *hw)
{
    return hw->reg_0x43.v;
}

/* REG_0x43:reg_0x43->mail_tdata1:31:0,向tid发送的数据tdata1,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x43_mail_tdata1(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x43.v = value;
}
...
static inline uint32_t mbox0_ll_get_reg_0x44_value(mbox0_hw_t *hw)
{
    return hw->reg_0x44.v;
}

static inline void mbox0_ll_set_reg_0x44_value(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x44.v = value;
}

/* REG_0x44:reg_0x44->mail_tid:3:0,接收端tid,兼开始发送功能,0x0,R/W*/
static inline uint32_t mbox0_ll_get_reg_0x44_mail_tid(mbox0_hw_t *hw)
{
    return hw->reg_0x44.mail_tid;
}

/* REG_0x44:reg_0x34->mail_tid:3:0,接收端tid,兼开始发送功能,0x0,R/W*/
static inline void mbox0_ll_set_reg_0x44_mail_tid(mbox0_hw_t *hw, uint32_t value)
{
    hw->reg_0x44.mail_tid = value;
}

/* REG_0x45 */

static inline uint32_t mbox0_ll_get_reg_0x45_value(mbox0_hw_t *hw)
{
    return hw->reg_0x45.v;
}

/* REG_0x45:reg_0x45->mail_sid:3:0,发送端sid,兼开始接收功能,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x45_mail_sid(mbox0_hw_t *hw)
{
    return hw->reg_0x45.mail_sid;
}

/* REG_0x46 */

static inline uint32_t mbox0_ll_get_reg_0x46_value(mbox0_hw_t *hw)
{
    return hw->reg_0x46.v;
}

/* REG_0x46:reg_0x46->mail_rdata0:31:0,读数据rdata0,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x46_mail_rdata0(mbox0_hw_t *hw)
{
    return hw->reg_0x46.v;
}
...
static inline uint32_t mbox0_ll_get_reg_0x47_value(mbox0_hw_t *hw)
{
    return hw->reg_0x47.v;
}

/* REG_0x47:reg_0x47->mail_rdata1:31:0,读数据rdata1,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x47_mail_rdata1(mbox0_hw_t *hw)
{
    return hw->reg_0x47.v;
}
...
static inline uint32_t mbox0_ll_get_reg_0x48_value(mbox0_hw_t *hw)
{
    return hw->reg_0x48.v;
}

/* REG_0x48:reg_0x48->fifo_full:0,fifo满标志,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x48_fifo_full(mbox0_hw_t *hw)
{
    return hw->reg_0x48.fifo_full;
}

/* REG_0x48:reg_0x48->fifo_empt:1,fifo空标志,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x48_fifo_empt(mbox0_hw_t *hw)
{
    return hw->reg_0x48.fifo_empt;
}

/* REG_0x48:reg_0x48->fifo_count:7:2,当前fifo内数据个数,0x0,R*/
static inline uint32_t mbox0_ll_get_reg_0x48_fifo_count(mbox0_hw_t *hw)
{
    return hw->reg_0x48.fifo_count;
}
