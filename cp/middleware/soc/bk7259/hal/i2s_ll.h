...
#endif
#ifndef I2S3_LL_REG_BASE
#define I2S3_LL_REG_BASE  SOC_I2S3_REG_BASE
#endif
#ifndef I2S4_LL_REG_BASE
#define I2S4_LL_REG_BASE  SOC_I2S4_REG_BASE
#endif
...
static inline uint32_t i2s_ll_get_dev_addr_by_idx(i2s_channel_idx idx) {
	...
	} else if (idx == I2S_CHANN_3) {
		addr = I2S3_LL_REG_BASE;
	} else if (idx == I2S_CHANN_4) {
		addr = I2S4_LL_REG_BASE;
	} else {
		addr = 0;
	}
