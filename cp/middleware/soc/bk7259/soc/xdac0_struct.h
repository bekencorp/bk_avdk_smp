...
typedef volatile struct {
	volatile xdac0_reg0_t reg0;
	volatile xdac0_reg1_t reg1;
	volatile xdac0_reg2_t reg2;
	volatile xdac0_reg3_t reg3;
	volatile xdac0_reg4_t reg4;
	volatile xdac0_reg5_t reg5;
	volatile xdac0_reg6_t reg6;
	volatile xdac0_reg7_t reg7;
	volatile xdac0_reg8_t reg8;
} xdac0_hw_t;
