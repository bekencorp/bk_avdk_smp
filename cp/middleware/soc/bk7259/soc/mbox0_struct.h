...
typedef volatile struct {
    ...
    union
    {
        struct
        {
           ...
           volatile uint32_t  int_status_chn3                : 1;  //2,ch4 中断状态 0：无中断。  1： 有中断,0x0,R
    ...
    union
    {
        struct
        {
           ...
           volatile uint32_t  fifo_length                    : 4;  //6:1,chn0的fifo的深度,0x0,R/W
           volatile uint32_t  reserved7                      :27;
        };
        uint32_t v;
    }reg_0x11;
    ...
    union
    {
        struct
        {
           ...
           volatile uint32_t  fifo_length                    : 4;  //6:1,chn1的fifo的深度,0x0,R/W
           volatile uint32_t  reserved7                      :27;
        };
        uint32_t v;
    }reg_0x21;
    ...
    union
    {
        ...
        {
           volatile uint32_t  chn_enable                     : 1;  //0,使能信号,0x0,R/W
           volatile uint32_t  fifo_length                    : 4;  //6:1,chn2的fifo的深度,0x0,R/W
           volatile uint32_t  reserved7                      :27;
        };
        uint32_t v;
    }reg_0x31;
    ...
    union
    {
        struct
        {
           volatile uint32_t  fifo_start                     : 6;  //5:0,chn3的fifo起始地址,0x0,R/W
           volatile uint32_t  reserved6                      : 2;
           volatile uint32_t  int_en                         : 1;  //8,1: chn3 int enable 0: chn3 int disable,0x1,R/W
           volatile uint32_t  int_wrerr_en                   : 1;  //9,1:写异常中断使能    0：写异常中断不使能,0x0,R/W
           volatile uint32_t  int_rderr_en                   : 1;  //10,1:读异常中断使能    0：读异常中断不使能,0x0,R/W
           volatile uint32_t  int_wrfull_en                  : 1;  //11,1:写满异常中断使能  0：写满异常中断不使能,0x1,R/W
           volatile uint32_t  reserved12                     : 4;
    ...
    union
    {
        ...
        {
           volatile uint32_t  chn_enable                     : 1;  //0,使能信号,0x0,R/W
           volatile uint32_t  fifo_length                    : 4;  //6:1,chn3的fifo的深度,0x0,R/W
           volatile uint32_t  reserved7                      :27;
        };
        uint32_t v;
    }reg_0x41;
