...
static void sys_dump_cpu2_int_halt_clk_op(void)
{
	...
	SOC_LOGI("cpu2_int_halt_clk_op: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x6 << 2)));
	SOC_LOGI("	cpu2_sw_rst: %8x\r\n", r->cpu2_sw_rst);
	SOC_LOGI("	cpu2_pwr_dw: %8x\r\n", r->cpu2_pwr_dw);
	SOC_LOGI("	cpu2_int_mask: %8x\r\n", r->cpu2_int_mask);
	SOC_LOGI("	cpu2_halt: %8x\r\n", r->cpu2_halt);
	SOC_LOGI("	cpu2_speed : %8x\r\n", r->cpu2_speed );
	SOC_LOGI("	cpu2_rxevt_sel: %8x\r\n", r->cpu2_rxevt_sel);
	SOC_LOGI("	reserved_6_7: %8x\r\n", r->reserved_6_7);
	SOC_LOGI("	cpu2_offset: %8x\r\n", r->cpu2_offset);
}

static void sys_dump_reserved_reg0x7(void)
{
	SOC_LOGI("reserved_reg0x7: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x7 << 2)));
}
...
static void sys_dump_cpu_26m_wdt_clk_div(void)
{
	...
	SOC_LOGI("	ckdiv_enet: %8x\r\n", r->ckdiv_enet);
	SOC_LOGI("	cksel_enet: %8x\r\n", r->cksel_enet);
	SOC_LOGI("	ckdiv_jpeg: %8x\r\n", r->ckdiv_jpeg);
	SOC_LOGI("	cksel_jpeg: %8x\r\n", r->cksel_jpeg);
	SOC_LOGI("	cksel_auxs_cis: %8x\r\n", r->cksel_auxs_cis);
	SOC_LOGI("	ckdiv_auxs_cis: %8x\r\n", r->ckdiv_auxs_cis);
...
static void sys_dump_reserver_reg0xd(void)
{
	...
	SOC_LOGI("	lin_cken: %8x\r\n", r->lin_cken);
	SOC_LOGI("	scr_cken: %8x\r\n", r->scr_cken);
	SOC_LOGI("	enet_cken: %8x\r\n", r->enet_cken);
	SOC_LOGI("	jpeg_cken: %8x\r\n", r->jpeg_cken);
	SOC_LOGI("	cis_auxs_cken: %8x\r\n", r->cis_auxs_cken);
...
static void sys_dump_cpu_device_mem_ctrl1(void)
{
	...
	SOC_LOGI("	uart1_sd: %8x\r\n", r->uart1_sd);
	SOC_LOGI("	uart2_sd: %8x\r\n", r->uart2_sd);
	SOC_LOGI("	spi1_sd: %8x\r\n", r->spi1_sd);
	SOC_LOGI("	sdio_sd: %8x\r\n", r->sdio_sd);
	SOC_LOGI("	usb_sd: %8x\r\n", r->usb_sd);
	SOC_LOGI("	can_sd: %8x\r\n", r->can_sd);
	SOC_LOGI("	qspi0_sd: %8x\r\n", r->qspi0_sd);
	SOC_LOGI("	qspi1_sd: %8x\r\n", r->qspi1_sd);
	SOC_LOGI("	pram_sd: %8x\r\n", r->pram_sd);
	SOC_LOGI("	fft_sd: %8x\r\n", r->fft_sd);
	SOC_LOGI("	abc_sd: %8x\r\n", r->abc_sd);
	SOC_LOGI("	aud_sd: %8x\r\n", r->aud_sd);
...
static void sys_dump_cpu_power_sleep_wakeup(void)
{
	...
	SOC_LOGI("	sleep_en_need_cpu2_wfi: %8x\r\n", r->sleep_en_need_cpu2_wfi);
	...
	SOC_LOGI("	cpu2_ticktimer_32k_enable: %8x\r\n", r->cpu2_ticktimer_32k_enable);
...
static void sys_dump_cpu0_lv_sleep_cfg(void)
{
	...
	SOC_LOGI("	cpu0_fpu_sleeppwd_en: %8x\r\n", r->cpu0_fpu_sleeppwd_en);
	SOC_LOGI("	sys2flsh_2wire: %8x\r\n", r->sys2flsh_2wire);
}
...
static void sys_dump_cpu_device_mem_ctrl3(void)
{
	...
	SOC_LOGI("	scal0_deep_sleep: %8x\r\n", r->scal0_deep_sleep);
	SOC_LOGI("	scal1_deep_sleep: %8x\r\n", r->scal1_deep_sleep);
	...
	SOC_LOGI("	scal0_shutdown: %8x\r\n", r->scal0_shutdown);
	SOC_LOGI("	scal1_shutdown: %8x\r\n", r->scal1_shutdown);
}
...
static void sys_dump_cpu2_int_0_31_en(void)
{
	...
	SOC_LOGI("cpu2_int_0_31_en: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x24 << 2)));
	SOC_LOGI("	cpu2_dma0_nsec_intr_en: %8x\r\n", r->cpu2_dma0_nsec_intr_en);
	SOC_LOGI("	cpu2_encp_sec_intr_en: %8x\r\n", r->cpu2_encp_sec_intr_en);
	SOC_LOGI("	cpu2_encp_nsec_intr_en: %8x\r\n", r->cpu2_encp_nsec_intr_en);
	SOC_LOGI("	cpu2_timer0_int_en: %8x\r\n", r->cpu2_timer0_int_en);
	SOC_LOGI("	cpu2_uart_int_en: %8x\r\n", r->cpu2_uart_int_en);
	SOC_LOGI("	cpu2_pwm0_int_en: %8x\r\n", r->cpu2_pwm0_int_en);
	SOC_LOGI("	cpu2_i2c0_int_en: %8x\r\n", r->cpu2_i2c0_int_en);
	SOC_LOGI("	cpu2_spi0_int_en: %8x\r\n", r->cpu2_spi0_int_en);
	SOC_LOGI("	cpu2_sadc_int_en: %8x\r\n", r->cpu2_sadc_int_en);
	SOC_LOGI("	cpu2_irda_int_en: %8x\r\n", r->cpu2_irda_int_en);
	SOC_LOGI("	cpu2_sdio_int_en: %8x\r\n", r->cpu2_sdio_int_en);
	SOC_LOGI("	cpu2_gdma_int_en: %8x\r\n", r->cpu2_gdma_int_en);
	SOC_LOGI("	cpu2_la_int_en: %8x\r\n", r->cpu2_la_int_en);
	SOC_LOGI("	cpu2_timer1_int_en: %8x\r\n", r->cpu2_timer1_int_en);
	SOC_LOGI("	cpu2_i2c1_int_en: %8x\r\n", r->cpu2_i2c1_int_en);
	SOC_LOGI("	cpu2_uart1_int_en: %8x\r\n", r->cpu2_uart1_int_en);
	SOC_LOGI("	cpu2_uart2_int_en: %8x\r\n", r->cpu2_uart2_int_en);
	SOC_LOGI("	cpu2_spi1_int_en: %8x\r\n", r->cpu2_spi1_int_en);
	SOC_LOGI("	cpu2_can_int_en: %8x\r\n", r->cpu2_can_int_en);
	SOC_LOGI("	cpu2_usb_int_en: %8x\r\n", r->cpu2_usb_int_en);
	SOC_LOGI("	cpu2_qspi0_int_en: %8x\r\n", r->cpu2_qspi0_int_en);
	SOC_LOGI("	cpu2_fft_int_en: %8x\r\n", r->cpu2_fft_int_en);
	SOC_LOGI("	cpu2_sbc_int_en: %8x\r\n", r->cpu2_sbc_int_en);
	SOC_LOGI("	cpu2_aud_int_en: %8x\r\n", r->cpu2_aud_int_en);
	SOC_LOGI("	cpu2_i2s0_int_en: %8x\r\n", r->cpu2_i2s0_int_en);
	SOC_LOGI("	cpu2_jpegenc_int_en: %8x\r\n", r->cpu2_jpegenc_int_en);
	SOC_LOGI("	cpu2_jpegdec_int_en: %8x\r\n", r->cpu2_jpegdec_int_en);
	SOC_LOGI("	cpu2_lcd_display_int_en: %8x\r\n", r->cpu2_lcd_display_int_en);
	SOC_LOGI("	cpu2_dma2d_int_en: %8x\r\n", r->cpu2_dma2d_int_en);
	SOC_LOGI("	cpu2_wifi_int_phy_mpb_en: %8x\r\n", r->cpu2_wifi_int_phy_mpb_en);
	SOC_LOGI("	cpu2_wifi_int_phy_riu_en: %8x\r\n", r->cpu2_wifi_int_phy_riu_en);
	SOC_LOGI("	cpu2_wifi_mac_int_tx_rx_timer_en: %8x\r\n", r->cpu2_wifi_mac_int_tx_rx_timer_en);
}
...
static void sys_dump_cpu2_int_32_63_en(void)
{
	...
	SOC_LOGI("cpu2_int_32_63_en: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x25 << 2)));
	SOC_LOGI("	cpu2_wifi_mac_int_tx_rx_misc_en: %8x\r\n", r->cpu2_wifi_mac_int_tx_rx_misc_en);
	SOC_LOGI("	cpu2_wifi_mac_int_rx_trigger_en: %8x\r\n", r->cpu2_wifi_mac_int_rx_trigger_en);
	SOC_LOGI("	cpu2_wifi_mac_int_tx_trigger_en: %8x\r\n", r->cpu2_wifi_mac_int_tx_trigger_en);
	SOC_LOGI("	cpu2_wifi_mac_int_prot_trigger_en: %8x\r\n", r->cpu2_wifi_mac_int_prot_trigger_en);
	SOC_LOGI("	cpu2_wifi_mac_int_gen_en: %8x\r\n", r->cpu2_wifi_mac_int_gen_en);
	SOC_LOGI("	cpu2_wifi_hsu_irq_en: %8x\r\n", r->cpu2_wifi_hsu_irq_en);
	SOC_LOGI("	cpu2_wifi_int_mac_wakeup_en: %8x\r\n", r->cpu2_wifi_int_mac_wakeup_en);
	SOC_LOGI("	cpu2_dm_irq_en: %8x\r\n", r->cpu2_dm_irq_en);
	SOC_LOGI("	cpu2_ble_irq_en: %8x\r\n", r->cpu2_ble_irq_en);
	SOC_LOGI("	cpu2_bt_irq_en: %8x\r\n", r->cpu2_bt_irq_en);
	SOC_LOGI("	cpu2_qspi1_int_en: %8x\r\n", r->cpu2_qspi1_int_en);
	SOC_LOGI("	cpu2_pwm1_int_en: %8x\r\n", r->cpu2_pwm1_int_en);
	SOC_LOGI("	cpu2_i2s1_int_en: %8x\r\n", r->cpu2_i2s1_int_en);
	SOC_LOGI("	cpu2_i2s2_int_en: %8x\r\n", r->cpu2_i2s2_int_en);
	SOC_LOGI("	cpu2_h264_int_en: %8x\r\n", r->cpu2_h264_int_en);
	SOC_LOGI("	cpu2_sdmadc_int_en: %8x\r\n", r->cpu2_sdmadc_int_en);
	SOC_LOGI("	cpu2_mbox0_int_en: %8x\r\n", r->cpu2_mbox0_int_en);
	SOC_LOGI("	cpu2_mbox1_int_en: %8x\r\n", r->cpu2_mbox1_int_en);
	SOC_LOGI("	cpu2_bmc64_int_en: %8x\r\n", r->cpu2_bmc64_int_en);
	SOC_LOGI("	cpu2_dpll_unlock_int_en: %8x\r\n", r->cpu2_dpll_unlock_int_en);
	SOC_LOGI("	cpu2_touched_int_en: %8x\r\n", r->cpu2_touched_int_en);
	SOC_LOGI("	cpu2_usbplug_int_en: %8x\r\n", r->cpu2_usbplug_int_en);
	SOC_LOGI("	cpu2_rtc_int_en: %8x\r\n", r->cpu2_rtc_int_en);
	SOC_LOGI("	cpu2_gpio_int_en: %8x\r\n", r->cpu2_gpio_int_en);
...
static void sys_dump_cpu2_int_0_31_status(void)
{
	...
	SOC_LOGI("cpu2_int_0_31_status: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x2c << 2)));
	SOC_LOGI("	cpu2_dma0_nsec_intr_st: %8x\r\n", r->cpu2_dma0_nsec_intr_st);
	SOC_LOGI("	cpu2_encp_sec_intr_st: %8x\r\n", r->cpu2_encp_sec_intr_st);
	SOC_LOGI("	cpu2_encp_nsec_intr_st: %8x\r\n", r->cpu2_encp_nsec_intr_st);
	SOC_LOGI("	cpu2_timer0_int_st: %8x\r\n", r->cpu2_timer0_int_st);
	SOC_LOGI("	cpu2_uart_int_st: %8x\r\n", r->cpu2_uart_int_st);
	SOC_LOGI("	cpu2_pwm0_int_st: %8x\r\n", r->cpu2_pwm0_int_st);
	SOC_LOGI("	cpu2_i2c0_int_st: %8x\r\n", r->cpu2_i2c0_int_st);
	SOC_LOGI("	cpu2_spi0_int_st: %8x\r\n", r->cpu2_spi0_int_st);
	SOC_LOGI("	cpu2_sadc_int_st: %8x\r\n", r->cpu2_sadc_int_st);
	SOC_LOGI("	cpu2_irda_int_st: %8x\r\n", r->cpu2_irda_int_st);
	SOC_LOGI("	cpu2_sdio_int_st: %8x\r\n", r->cpu2_sdio_int_st);
	SOC_LOGI("	cpu2_gdma_int_st: %8x\r\n", r->cpu2_gdma_int_st);
	SOC_LOGI("	cpu2_la_int_st: %8x\r\n", r->cpu2_la_int_st);
	SOC_LOGI("	cpu2_timer1_int_st: %8x\r\n", r->cpu2_timer1_int_st);
	SOC_LOGI("	cpu2_i2c1_int_st: %8x\r\n", r->cpu2_i2c1_int_st);
	SOC_LOGI("	cpu2_uart1_int_st: %8x\r\n", r->cpu2_uart1_int_st);
	SOC_LOGI("	cpu2_uart2_int_st: %8x\r\n", r->cpu2_uart2_int_st);
	SOC_LOGI("	cpu2_spi1_int_st: %8x\r\n", r->cpu2_spi1_int_st);
	SOC_LOGI("	cpu2_can_int_st: %8x\r\n", r->cpu2_can_int_st);
	SOC_LOGI("	cpu2_usb_int_st: %8x\r\n", r->cpu2_usb_int_st);
	SOC_LOGI("	cpu2_qspi0_int_st: %8x\r\n", r->cpu2_qspi0_int_st);
	SOC_LOGI("	cpu2_fft_int_st: %8x\r\n", r->cpu2_fft_int_st);
	SOC_LOGI("	cpu2_sbc_int_st: %8x\r\n", r->cpu2_sbc_int_st);
	SOC_LOGI("	cpu2_aud_int_st: %8x\r\n", r->cpu2_aud_int_st);
	SOC_LOGI("	cpu2_i2s0_int_st: %8x\r\n", r->cpu2_i2s0_int_st);
	SOC_LOGI("	cpu2_jpegenc_int_st: %8x\r\n", r->cpu2_jpegenc_int_st);
	SOC_LOGI("	cpu2_jpegdec_int_st: %8x\r\n", r->cpu2_jpegdec_int_st);
	SOC_LOGI("	cpu2_lcd_display_int_st: %8x\r\n", r->cpu2_lcd_display_int_st);
	SOC_LOGI("	cpu2_dma2d_int_st: %8x\r\n", r->cpu2_dma2d_int_st);
	SOC_LOGI("	cpu2_wifi_int_phy_mpb_st: %8x\r\n", r->cpu2_wifi_int_phy_mpb_st);
	SOC_LOGI("	cpu2_wifi_int_phy_riu_st: %8x\r\n", r->cpu2_wifi_int_phy_riu_st);
	SOC_LOGI("	cpu2_wifi_mac_int_tx_rx_timer_st: %8x\r\n", r->cpu2_wifi_mac_int_tx_rx_timer_st);
}
...
static void sys_dump_cpu2_int_32_63_status(void)
{
	...
	SOC_LOGI("cpu2_int_32_63_status: %8x\r\n", REG_READ(SOC_SYS_REG_BASE + (0x2d << 2)));
	SOC_LOGI("	cpu2_wifi_mac_int_tx_rx_misc_st: %8x\r\n", r->cpu2_wifi_mac_int_tx_rx_misc_st);
	SOC_LOGI("	cpu2_wifi_mac_int_rx_trigger_st: %8x\r\n", r->cpu2_wifi_mac_int_rx_trigger_st);
	SOC_LOGI("	cpu2_wifi_mac_int_tx_trigger_st: %8x\r\n", r->cpu2_wifi_mac_int_tx_trigger_st);
	SOC_LOGI("	cpu2_wifi_mac_int_prot_trigger_st: %8x\r\n", r->cpu2_wifi_mac_int_prot_trigger_st);
	SOC_LOGI("	cpu2_wifi_mac_int_gen_st: %8x\r\n", r->cpu2_wifi_mac_int_gen_st);
	SOC_LOGI("	cpu2_wifi_hsu_irq_st: %8x\r\n", r->cpu2_wifi_hsu_irq_st);
	SOC_LOGI("	cpu2_wifi_int_mac_wakeup_st: %8x\r\n", r->cpu2_wifi_int_mac_wakeup_st);
	SOC_LOGI("	cpu2_dm_irq_st: %8x\r\n", r->cpu2_dm_irq_st);
	SOC_LOGI("	cpu2_ble_irq_st: %8x\r\n", r->cpu2_ble_irq_st);
	SOC_LOGI("	cpu2_bt_irq_st: %8x\r\n", r->cpu2_bt_irq_st);
	SOC_LOGI("	cpu2_qspi1_int_st: %8x\r\n", r->cpu2_qspi1_int_st);
	SOC_LOGI("	cpu2_pwm1_int_st: %8x\r\n", r->cpu2_pwm1_int_st);
	SOC_LOGI("	cpu2_i2s1_int_st: %8x\r\n", r->cpu2_i2s1_int_st);
	SOC_LOGI("	cpu2_i2s2_int_st: %8x\r\n", r->cpu2_i2s2_int_st);
	SOC_LOGI("	cpu2_h264_int_st: %8x\r\n", r->cpu2_h264_int_st);
	SOC_LOGI("	cpu2_sdmadc_int_st: %8x\r\n", r->cpu2_sdmadc_int_st);
	SOC_LOGI("	cpu2_mbox0_int_st: %8x\r\n", r->cpu2_mbox0_int_st);
	SOC_LOGI("	cpu2_mbox1_int_st: %8x\r\n", r->cpu2_mbox1_int_st);
	SOC_LOGI("	cpu2_bmc64_int_st: %8x\r\n", r->cpu2_bmc64_int_st);
	SOC_LOGI("	cpu2_dpll_unlock_int_st: %8x\r\n", r->cpu2_dpll_unlock_int_st);
	SOC_LOGI("	cpu2_touched_int_st: %8x\r\n", r->cpu2_touched_int_st);
	SOC_LOGI("	cpu2_usbplug_int_st: %8x\r\n", r->cpu2_usbplug_int_st);
	SOC_LOGI("	cpu2_rtc_int_st: %8x\r\n", r->cpu2_rtc_int_st);
	SOC_LOGI("	cpu2_gpio_int_st: %8x\r\n", r->cpu2_gpio_int_st);
	SOC_LOGI("	cpu2_dma1_sec_int_st: %8x\r\n", r->cpu2_dma1_sec_int_st);
	SOC_LOGI("	cpu2_dma1_nsec_int_st: %8x\r\n", r->cpu2_dma1_nsec_int_st);
	SOC_LOGI("	cpu2_yuvb_int_st: %8x\r\n", r->cpu2_yuvb_int_st);
	SOC_LOGI("	reserved0: %8x\r\n", r->reserved0);
}
...
static void sys_dump_ana_reg3(void)
{
	...
	SOC_LOGI("	lbw0v9: %8x\r\n", r->lbw0v9);
	SOC_LOGI("	sdclk_sel: %8x\r\n", r->sdclk_sel);
	SOC_LOGI("	sarrlck_rlten: %8x\r\n", r->sarrlck_rlten);
	SOC_LOGI("	sarrlck_inv: %8x\r\n", r->sarrlck_inv);
	SOC_LOGI("	bufdrvtrm0v9: %8x\r\n", r->bufdrvtrm0v9);
	SOC_LOGI("	nc_5_5: %8x\r\n", r->nc_5_5);
	SOC_LOGI("	inbufen0v9: %8x\r\n", r->inbufen0v9);
	SOC_LOGI("	hres_sel0v9: %8x\r\n", r->hres_sel0v9);
	SOC_LOGI("	hpssren: %8x\r\n", r->hpssren);
	SOC_LOGI("	ck_sel: %8x\r\n", r->ck_sel);
...
static void sys_dump_ana_reg13(void)
{
	...
	SOC_LOGI("	nc_10_11: %8x\r\n", r->nc_10_11);
	SOC_LOGI("	vtrxspisel: %8x\r\n", r->vtrxspisel);
	SOC_LOGI("	nc_14_19: %8x\r\n", r->nc_14_19);
...
static void sys_dump_ana_reg18(void)
{
	...
	SOC_LOGI("	nc_24_29: %8x\r\n", r->nc_24_29);
	SOC_LOGI("	lchck_sel: %8x\r\n", r->lchck_sel);
...
static void sys_dump_ana_reg23(void)
{
	...
	SOC_LOGI("	lpfrz: %8x\r\n", r->lpfrz);
	SOC_LOGI("	vsel: %8x\r\n", r->vsel);
	SOC_LOGI("	nc_12_14: %8x\r\n", r->nc_12_14);
	SOC_LOGI("	pwd_lockdet: %8x\r\n", r->pwd_lockdet);
	SOC_LOGI("	nc_16_17: %8x\r\n", r->nc_16_17);
	SOC_LOGI("	spi_trigger: %8x\r\n", r->spi_trigger);
	SOC_LOGI("	manual: %8x\r\n", r->manual);
	SOC_LOGI("	test_en: %8x\r\n", r->test_en);
	SOC_LOGI("	nc_21_22: %8x\r\n", r->nc_21_22);
	SOC_LOGI("	icp: %8x\r\n", r->icp);
	SOC_LOGI("	nc_25_27: %8x\r\n", r->nc_25_27);
